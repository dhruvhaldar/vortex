    ...
    <div className="w-screen">
      ...
      <section aria-labelledby="hero-title" className="h-screen flex flex-col justify-center items-start p-10 md:p-20">
        ...
        <div className="absolute bottom-10 left-10 md:left-20 motion-safe:animate-bounce text-white/70 flex items-center gap-2">
            ...
            <span>Scroll or use <kbd className="font-sans px-1 py-0.5 rounded-md bg-white/20 text-xs"><span className="sr-only">down arrow</span><span aria-hidden="true">↓</span></kbd> <kbd className="font-sans px-1 py-0.5 rounded-md bg-white/20 text-xs"><span className="sr-only">up arrow</span><span aria-hidden="true">↑</span></kbd> to explore</span>
        </div>
      </section>
