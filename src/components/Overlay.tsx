    ...
    <div className="w-screen">
      ...
      <section aria-labelledby="explore-data-title" className="h-screen flex flex-col justify-center items-center p-10 md:p-20">
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="group px-6 py-3 bg-white text-black rounded-full font-bold hover:bg-gray-200 focus-within:bg-gray-200 transition-all pointer-events-auto inline-flex items-center gap-2 justify-center">
              Powered by <a href="https://github.com/pyvista/pyvista" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 focus-visible:outline-none focus-visible:bg-black/10 focus-visible:ring-2 focus-visible:ring-black rounded-sm px-1 transition-colors hover:underline">PyVista<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-external-link group-hover:-translate-y-1 group-focus-within:-translate-y-1 group-hover:translate-x-1 group-focus-within:translate-x-1 transition-transform" aria-hidden="true"><path d="M15 3h6v6"/><path d="M10 14 21 3"/><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/></svg><span className="sr-only"> (opens in a new tab)</span></a> & <abbr tabIndex={0} title="React Three Fiber" className="cursor-help underline decoration-black/50 decoration-dotted underline-offset-4 focus-visible:outline-none focus-visible:bg-black/10 focus-visible:ring-2 focus-visible:ring-black rounded-sm px-1 transition-colors">R3F</abbr>
          </div>
