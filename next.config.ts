...
const securityHeaders = [
  ...
  },
  {
    ...
    // Sentinel: Further hardened by disabling clipboard access, serial, gamepad, and window management to reduce attack surface.
  ...
  // Sentinel: Add X-Download-Options to prevent legacy browsers from executing downloaded files in the app's context
  {
